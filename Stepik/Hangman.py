...
def play():
    ...
    while True:
        letter = input('Введите букву здесь: ')
        index = 0
        count = 0

        if not letter.isalpha():
            print('Вы ввели не букву! Введите букву.')
            continue

        if letter in guessed_letters:
            print('Вы уже вводили эту букву, введите новую.')
            continue
        else:
        ...
        if count > 0:
            ...
            print('Такой буквы нет в задуманном слове!')
            tries -= 1
            print(display_hangman(tries))
...
# def find_word(letter, word, count, index):
def play_again():
